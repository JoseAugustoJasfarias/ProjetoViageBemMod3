    ...
    public class DestinoesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var destino = await _context.destino
                .FirstOrDefaultAsync(m => m.Id_Destino_Cliente == id);
            if (destino == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id_Destino_Cliente,NomeDestino,Pais,DataViagem")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Destino_Cliente,NomeDestino,Pais,DataViagem")] Destino destino)
        {
            if (id != destino.Id_Destino_Cliente)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DestinoExists(destino.Id_Destino_Cliente))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.destino.Any(e => e.Id_Destino_Cliente == id);
        }
    }
}
