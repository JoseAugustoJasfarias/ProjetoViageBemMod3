...
namespace ViajeBem.Controllers
{
    public class ContatoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Contato,Nome,Email,Telefone,Destino,Mensagem")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Contato,Nome,Email,Telefone,Destino,Mensagem")] Contato contato)
        {
